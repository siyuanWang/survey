ALTER TABLE SYSTEM.SURVEY
 DROP PRIMARY KEY CASCADE;

DROP TABLE SYSTEM.SURVEY CASCADE CONSTRAINTS;

CREATE TABLE SYSTEM.SURVEY
(
  ID     VARCHAR2(4000 BYTE)                    NOT NULL,
  NAME   VARCHAR2(4000 BYTE),
  HOBBY  VARCHAR2(4000 BYTE)
)
TABLESPACE SYSTEM
PCTUSED    40
PCTFREE    10
...
ALTER TABLE SYSTEM.SURVEY_PAPER_QUESTION
 DROP PRIMARY KEY CASCADE;

DROP TABLE SYSTEM.SURVEY_PAPER_QUESTION CASCADE CONSTRAINTS;

CREATE TABLE SYSTEM.SURVEY_PAPER_QUESTION
(
  ID           NUMBER                           NOT NULL,
...
CREATE UNIQUE INDEX SYSTEM.SURVEY_PK ON SYSTEM.SURVEY
(ID)
LOGGING
TABLESPACE SYSTEM
PCTFREE    10
...
CREATE UNIQUE INDEX SYSTEM.TABLE1_PK ON SYSTEM.SURVEY_PAPER_QUESTION
(ID)
LOGGING
TABLESPACE SYSTEM
PCTFREE    10
...
ALTER TABLE SYSTEM.SURVEY ADD (
  CONSTRAINT SURVEY_PK
  PRIMARY KEY
  (ID)
  USING INDEX SYSTEM.SURVEY_PK
  ENABLE VALIDATE);
...
ALTER TABLE SYSTEM.SURVEY_PAPER_QUESTION ADD (
